...
Перевірив. У коді є кілька явних пошкоджень синтаксису/форматування, зокрема зайві символи − і поламані CSS-рядки. Я їх виправив і зберіг чисту версію коду.



Завантажити виправлений код

Якщо хочеш, можу ще повністю пройтися по логіці трекера — вага, дефіцит, БМР, тренування, Gemini та Google Sheets — і виправити вже не тільки синтаксис, а й помилки в розрахунках. 


трекер_виправлений.py
Код
